...
export const ModelPickerContent = memo(function ModelPickerContent(props: {
  ...
  return (
    <TooltipProvider delay={0}>
      <div
        className={cn(
          "dropdown-glass relative flex h-screen max-h-86.5 w-screen max-w-90 flex-row overflow-hidden rounded-lg text-popover-foreground [clip-path:inset(0_round_var(--radius-lg))]",

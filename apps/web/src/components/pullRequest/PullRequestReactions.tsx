...
const PILL_CLASS =
  "inline-flex h-6 shrink-0 cursor-pointer items-center gap-1 rounded-full border px-2 text-xs outline-none transition-colors focus-visible:ring-2 focus-visible:ring-ring";
              ...
              {PULL_REQUEST_REACTION_ORDER.map((content) => {
                ...
                return (
                  <button
                    ...
                    className={cn(
                      "flex size-7 cursor-pointer items-center justify-center rounded-md text-base outline-none transition-colors hover:bg-accent focus-visible:ring-2 focus-visible:ring-ring",

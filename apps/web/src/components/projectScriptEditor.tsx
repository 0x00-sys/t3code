            ...
            <form id={formId} className="space-y-4" onSubmit={submit}>
                        ...
                        {SCRIPT_ICONS.map((entry) => {
                          ...
                          return (
                            <button
                              key={entry.id}
                              type="button"
                              className={`relative flex cursor-pointer flex-col items-center gap-2 rounded-md border px-2 py-2 text-xs transition-colors dark:border-transparent ${
                                isSelected
              ...
              <label
                className={`flex items-center justify-between gap-3 rounded-md border border-border/70 px-3 py-2 text-sm dark:border-transparent dark:bg-white/[0.035] ${
                  previewUrl.trim().length === 0 ? "opacity-64" : ""
                }`}
              >

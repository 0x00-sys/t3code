  ...
  return (
    ...
    >
      ...
      <div className="relative min-h-0 flex-1 overflow-hidden">
        ...
        {controller !== "none" ? (
          <div className="pointer-events-none absolute left-3 top-3 z-40 rounded-full border border-border/70 bg-popover/95 px-2.5 py-1 text-xs font-medium shadow-md/10 backdrop-blur">
